...
class Deb::S3::Release
  ...
  def write_to_s3
    ...
    if Deb::S3::Utils.signing_key
      ...
      if system("gpg -a #{key_param} --digest-algo SHA512 #{Deb::S3::Utils.gpg_options} -s --clearsign #{release_tmp.path}")
      ...
      if system("gpg -a #{key_param} --digest-algo SHA512 #{Deb::S3::Utils.gpg_options} -b #{release_tmp.path}")
        local_file = release_tmp.path+".asc"
